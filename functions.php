...
add_action( 'after_setup_theme', 'myxon_setup' );

  function myxon_setup() {
...
add_action( 'wp_enqueue_scripts', 'myxon_scripts' );

  function myxon_scripts() {
    // javascripts
...
add_action( 'after_setup_theme', 'myxon_files' );

  function myxon_files() {
...
add_action( 'widgets_init', 'myxon_widgets_init' );

  function myxon_widgets_init() {
...
add_filter( 'get_search_form', 'myxon_search_form' );

  function myxon_search_form( $form ) {
